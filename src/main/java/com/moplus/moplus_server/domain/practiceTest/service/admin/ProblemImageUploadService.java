...
import com.moplus.moplus_server.domain.practiceTest.dto.admin.request.ProblemImageRequest;
import com.moplus.moplus_server.domain.practiceTest.repository.PracticeTestRepository;
import com.moplus.moplus_server.domain.practiceTest.repository.ProblemImageRepository;
...
public class ProblemImageUploadService {
    ...
    public void uploadImage(Long practiceId, Long problemId, MultipartFile image) {
        ...
        ProblemImage problemImage = ProblemImage.builder()
                ...
                .build();
        ProblemImage saved = problemImageRepository.save(problemImage);
        problem.addImage(saved);
