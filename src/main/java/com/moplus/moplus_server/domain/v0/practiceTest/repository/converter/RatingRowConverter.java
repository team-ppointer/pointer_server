package com.moplus.moplus_server.domain.v0.practiceTest.repository.converter;
    ...
    public List<RatingRow> convertToEntityAttribute(String dbData) {
        ...
        try {
            return objectMapper.readValue(dbData,
                    objectMapper.getTypeFactory().constructCollectionType(List.class, RatingRow.class));
        } catch (JsonProcessingException e) {
